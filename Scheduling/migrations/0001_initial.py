# Generated by Django 4.1 on 2022-09-27 19:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tech', models.EmailField(max_length=254, unique=True, verbose_name='email')),
                ...
                ('friday_timeSlots', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, related_name='fridayTimeSlots', to='Scheduling.timeslots')),
                ('monday_timeSlots', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, related_name='mondayTimeSlots', to='Scheduling.timeslots')),
                ('saturday_timeSlots', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, related_name='saturdayTimeSlots', to='Scheduling.timeslots')),
                ('sunday_timeSlots', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, related_name='sundayTimeSlots', to='Scheduling.timeslots')),
                ('thursday_timeSlots', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, related_name='thursdayTimeSlots', to='Scheduling.timeslots')),
                ('tuesday_timeSlots', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, related_name='tuesdayTimeSlots', to='Scheduling.timeslots')),
                ('wednesday_timeSlots', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, related_name='wednesdayTimeSlots', to='Scheduling.timeslots')),
            ],
        ),
    ]
